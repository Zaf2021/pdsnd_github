# -*- coding: utf-8 -*-
"""
Created on Tue Aug 17 17:40:26 2021
...
# This is where we define the city data
...
def get_filters():
    ...
    """
    print('\033[39m Hello! Let\'s explore some US bikeshare data!')
    ...
    while True:
        day=str(input('\033[1;32m Do you want to filter by day? If yes, then type out the day. \n (Monday,Tuesday,Wednesday,Thursday,Friday,Saturday,Sunday) \n If not, type in all\n')).title()
        if day not in days:
...
def main():
    ...
    while True:
        ...
        restart = input('\nWould you like to run another report? Enter yes or no.\n')
